...
// numerically integrate f from 0 to z (e.g. trapezoidal, n~512 steps).
//       Return 0 when z <= 0.
...
// comoving distance  = D_H * ∫_0^z dz'/E(z')
export const comovingGly = (z) => {
  return D_H * integrate((zz) => 1 / E(zz), z)
}

// light-travel dist  = D_H * ∫_0^z dz'/((1+z')·E(z'))
export const lightTravelGly = (z) => {
  return D_H * integrate((zz) => 1 / ((1 + zz) * E(zz)), z)
}

// luminosity distance = (1+z) * comoving distance   (flat universe)
